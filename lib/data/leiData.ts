...
export const leiApplicationGuide = [
  {
    ...
    id: "1",
    description:
      "Create your user account and log in after receiving confirmation.",
  },
  {
    name: "Apply for Your LEI",
    id: "2",
    description:
      "Click 'Apply' and complete the LEI application form provided.",
  },
  {
    name: "Receive Your LEI Code",
    id: "3",
    description:
      "Our experts will review your info and assign your LEI quickly.",
  },
];
...
export const leiBenefits = [
  {
    ...
    description:
      "Obtain a unique identifier for seamless global recognition and credibility.",
  },
  {
    name: "Transparency & Trust",
    description:
      "Clearly display your business structure, building trust with global partners.",
  },
  {
    name: "Regulatory Compliance",
    description:
      "Meet international legal and financial standards with ease through an LEI.",
  },
  {
    name: "Simplified Transactions",
    description:
      "Streamline cross-border operations and financial dealings with verified global identity.",
  },
];

export const aboutUs = [
  {
    name: "Global LEI Services",
    description:
      "Providing trusted LEI (Legal Entity Identifier) services to companies across 20+ countries.",
  },
  {
    name: "Accredited Issuer",
    description:
      "Certified to issue and manage LEIs, ensuring regulatory compliance and transparency.",
  },
  {
    name: "Seamless Application Process",
    description:
      "Simple, fast, and efficient process for obtaining and renewing LEIs.",
  },
  {
    name: "Customer-Centric Approach",
    description:
      "Dedicated support to guide clients through each step of the LEI process.",
  },
];
...
export const linksServices = [
  ...
  { name: "FAQ", id: "faq" },
  { name: "CDF downloads", id: "coming-soon" },
  { name: "LOU data analytics", id: "LOU data analytics" },
  { name: "Recent posts", id: "recent-posts" },
];
...
export const footerData = [
  {
      id:"1",
      name:"email",
      content:"#support@tnvlei.com"
  },
  {
      id:"2",
      name:"tel",
      content:"05224623936#2C2B40"
  },
  {
      id:"3",
      name:"address",
      content:"#TNV House, B, 1/19/69, Sector K, Aliganj, Lucknow, Uttar Pradesh 226024"
  }
]
